                <footer class="main-footer">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-xl-start justify-content-lg-start justify-content-md-start justify-content-center">
                            <p class="text-gradient-02">&copy; <?= date('Y'); ?>. <a href="#">Survey Kepuasan Pasien</a> - Primaya Hospital Karawang</p>
                        </div>
                    </div>
                </footer>
    ...
    <script>if (typeof jQuery === 'undefined' || typeof jQuery.fn.modal === 'undefined') { document.write('<script src="<?= base_url('assets-tamplate/tamplate/assets/vendors/js/base/bootstrap.bundle.min.js'); ?>"><\/script>'); }</script>
