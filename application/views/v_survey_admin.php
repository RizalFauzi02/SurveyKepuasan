      ...
      <div class="slides">
          ...
          <div class="info-card">
            ...
            <div class="info-row">
              ...
              <input type="text" name="tipe_fasilitas"
                class="input-no-style"
                value="Counter 1 - Administrasi Rawat Inap"
                readonly>
            </div>
        ...
        <div class="slide" id="slide-2">
          ...
          <div class="question-text" id="q-rating">
            Seberapa puas Bapak / Ibu terhadap pelayanan <span>Administrasi</span> kami? <span style="color:#ef4444">*</span>
          </div>
  ...
  <script>
    ...
    const translations = {
      id: {
        ...
        hint1: 'Tekan Enter',
        qRating: 'Seberapa puas Bapak / Ibu terhadap pelayanan <span>Administrasi</span> kami? <span style="color:#ef4444">*</span>',
